      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            >
              Transforme Sua Prática Hoje Mesmo
            </motion.h2>
            ...
            >
              Não perca a oportunidade de dominar o método que está revolucionando 
            ...
            <div className="mx-auto max-w-xs sm:flex sm:max-w-none sm:justify-center">
              ...
              >
                <a
                  ...
                  href="https://wa.me/5511999999999?text=🚨 URGENTE! Quero garantir minha vaga na mentoria LowerLift® antes que esgote!"
                  target="_blank"
            ...
            >
              <div className="flex items-center">
                ...
                <span className="text-sm">Certificação Inclusa</span>
              </div>
              <div className="flex items-center">
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
